...
%-----------------------e_instance---------------------------
dice(x, 0.16666666666, 0.16666666666, 0.16666666666, 0.16666666666, 0.16666666666, 0.16666666666, D ) :- between(1, 2, D).


%-----------------------e_action-----------------------------
alias_X(X1, X2) :- dice_roll(x, 0.16666666666, 0.16666666666, 0.16666666666, 0.16666666666, 0.16666666666, 0.16666666666, 1, X1 ), dice_roll(x, 0.16666666666, 0.16666666666, 0.16666666666, 0.16666666666, 0.16666666666, 0.16666666666, 2, X2 ) .
...
%----------------------------query---------------------------
q(4463) :- alias_X(X1, X2),  ( \+ ( ( X1 + X2 =:= 8 ) ; ( count([X1, X2],1, C1639) , C1639 = 2 ) ) ) . 
